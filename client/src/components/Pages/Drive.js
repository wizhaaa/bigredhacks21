  ...
  return (
    <div className="controlOverlay">
      <div className="leftside">
        <div className="controlelement" id="returntomap">
      ...
      <div className="rightside">
        ...
        >
          {props.musicOn ? "Play Music" : "Pause Music"}
        </div>
        <div
          className="controlelement"
          id="ambientnoise"
        ...
        >
          {props.ambienceOn ? "Play Ambient Noise" : "Pause Ambient Noise"}{" "}
        </div>
      </div>
    </div>
  );
